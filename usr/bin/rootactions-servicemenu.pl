...
sub recursion_dialog_msgs {
	...
	%RECURSIONTITLE = (
	   ...
	   "nb" => "Endre rekursivt?",
	   "nl" => "Wijzigingen recursief toepassen?",
	   "nn" => "Endra rekursivt?",
	...
	%RECURSIONMSG = (
	   ...
	   "nl" => "Wilt u de wijzigingen recursief toepassen op alle submappen en bestanden? \n(voorzichtig gebruiken)",
...
# Commands
$SUCOMMAND = 'pkexec env DISPLAY=$DISPLAY XAUTHORITY=$XAUTHORITY XDG_CURRENT_DESKTOP=$XDG_CURRENT_DESKTOP' ;
